export const blogData = [
  {
    id: 1,
    title: "Dropbox Clone DApp: Decentralised File Management Made Easy",
    description:
      "Enter Dropbox Clone DApp — a decentralized file management application leveraging blockchain and IPFS for secure, transparent, and reliable file storage.",
    date: "Dec 3, 2024",
    image:
      "https://miro.medium.com/v2/resize:fit:720/format:webp/1*siBlK-iE_W7LdJHwu46NRQ.png",
    url: "https://medium.com/@nandhuraju/dropbox-clone-dapp-decentralised-file-management-made-easy-d46cb7330cab",
  },
  {
    id: 2,
    title: "TopTalk: Your Personalized News Companion",
    description:
      "TopTalk is a web app that brings the important news to you, complete with features such as bookmarking and search, and even gives easy manageability to articles to admins.",
    date: "Dec 4, 2024",
    image:
      "https://miro.medium.com/v2/resize:fit:720/format:webp/1*awCSzNlGW2UcidR4JImejg.png",
    url: "https://medium.com/@nandhuraju/toptalk-your-personalized-news-companion-2f672b50bef4",
  },
  // {
  //     id: 3,
